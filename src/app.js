...
app.post("/footer",async (req,res)=>{
    ...
    try{
        ...
        const mailoptions = {
            ...
            text: 'Thank you for your feedback. \n in case of query we will get batck to you soon.'
        }
...
app.post("/reg",async (req,res)=>{
    ...
    console.log("name:", req.body.rfirstname );

    try{
        const Registerrecord= new Registeration({
    ...
    //    res.render("index");
        ...
        transporter.sendMail(mailoptions,(error,info)=>{
            ...
            return res.render("succesfulreg");
    }
    catch(e)
    {
        res.status(400);
